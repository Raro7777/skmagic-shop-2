              ...
              <div className="min-w-0">
                ...
                <div className="flex items-center gap-1 mt-1 flex-wrap">
                  ...
                  {p.maxRentalSupport > 0 && (
                    <span className="text-[10px] px-1.5 py-0.5 rounded bg-gradient-to-r from-rk-success to-[#0F7C3C] text-white font-extrabold rk-num shadow animate-pulse-cashback whitespace-nowrap">💰 +{fmt(p.maxRentalSupport)}원</span>
                  )}
                </div>
              </div>
