        ...
        <section className="bg-white px-4 py-3">
          {!trimmed ? (
            <div className="text-center py-8">
              ...
              <small className="text-[11px] text-rk-muted mt-1 block">예: PURE+, 비데, 안마의자</small>
            </div>
          ) : results.length === 0 ? (
            <div className="text-center py-10">
              ...
              <small className="text-[11px] text-rk-muted block mt-2">
                다른 키워드로 검색하거나 카테고리에서 둘러보세요.
              </small>
              <div className="mt-3 flex gap-2 justify-center flex-wrap">
                <Link href={`/p/${partner.partnerCode}/category/water`} className="text-[11px] bg-rk-soft px-2 py-1 rounded no-underline text-rk-text">정수기</Link>
                <Link href={`/p/${partner.partnerCode}/category/bidet`} className="text-[11px] bg-rk-soft px-2 py-1 rounded no-underline text-rk-text">비데</Link>
                <Link href={`/p/${partner.partnerCode}/products`} className="text-[11px] bg-rk-soft px-2 py-1 rounded no-underline text-rk-text">전체 상품</Link>
              </div>
            </div>
          ) : (
            <>
              <div className="text-[12px] text-rk-muted mb-3">
