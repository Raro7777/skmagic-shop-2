    ...
    <>
      ...
      <div className="mt-3 bg-rk-tint-blue text-rk-info px-3 py-2 rounded text-[13px] leading-[1.6]">
        ...
        <ul className="m-0 mt-1 pl-4 list-disc">
          <li>상품 조회: <code className="font-mono">GET https://rentking-next.vercel.app/api/external/products?category=water</code></li>
          <li>신청 받기: <code className="font-mono">POST https://rentking-next.vercel.app/api/external/leads</code></li>
